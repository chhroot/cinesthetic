...
import {
  Movie as MovieIcon,
  Theaters,
  Language, PlusOne, Favorite, FavoriteBorderOutlined, Remove, ArrowBack,
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          <Box display="flex" align="center">
            ...
            <Typography variant="subtitle1" gutterBottom style={{ margineLeft: '10px' }}>{data?.vote_average} / 10</Typography>
          </Box>
        ...
        <Typography style={{ margineBottom: '2rem' }}>
          {data?.overview}
        </Typography>
        <Typography variant="h5" style={{ marginTop: '10px' }} gutterBottom>Top Cast</Typography>
          ...
          <Grid item container style={{ marginTop: '2rem' }}>
            <div className={classes.buttonContainer}>
              <Grid item xs={12} sm={6} className={classes.buttonContainer}>
                <ButtonGroup color={(currentTheme === 'dark') ? 'secondary' : 'primary'} size="medium" variant="outlined">
              ...
              <Grid item xs={12} sm={6} className={classes.buttonContainer}>
                <ButtonGroup color={(currentTheme === 'dark') ? 'secondary' : 'primary'} className={classes.buttGroup} size="small" variant="outlined">
                  <Button
                  ...
                  <Button className={classes.butt} endIcon={<ArrowBack />} sx={{ borderColor: 'primary.main' }}>
